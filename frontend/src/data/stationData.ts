...
const BASE_STATIONS: Station[] = [
  ...
  { code: 'JAT', name: 'Jammu Tawi', city: 'Jammu', state: 'Jammu and Kashmir', aliases: ['JAMMU', 'JAT', 'JAMMU TAWI'] },
  { code: 'SVDK', name: 'SMVD Katra', city: 'Katra', state: 'Jammu and Kashmir', aliases: ['KATRA', 'SVDK', 'VAISHNO DEVI'] },
