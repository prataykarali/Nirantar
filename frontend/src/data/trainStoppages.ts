...
const FLAGSHIP_STOPS: Record<string, StationStop[]> = {
  ...
  '12313': [
    { code: 'SDAH', name: 'Sealdah Terminus', platform: 'Platform 9B', scheduledArr: '--:--', scheduledDep: '16:50', distanceKm: 0, doorSide: 'RIGHT SIDE', haltMins: 0, pillarInfo: 'Pillar #3 & Main Hall' },
    { code: 'DHN', name: 'Dhanbad Junction', platform: 'Platform 3', scheduledArr: '19:03', scheduledDep: '19:08', distanceKm: 266, doorSide: 'LEFT SIDE', haltMins: 5, pillarInfo: 'Pillar #8 & FOB' },
    { code: 'GAYA', name: 'Gaya Junction', platform: 'Platform 1', scheduledArr: '21:22', scheduledDep: '21:25', distanceKm: 461, doorSide: 'RIGHT SIDE', haltMins: 3, pillarInfo: 'Pillar #11 & Footover Bridge' },
    { code: 'DDU', name: 'Pt. Deen Dayal Upadhyaya', platform: 'Platform 2', scheduledArr: '23:15', scheduledDep: '23:25', distanceKm: 666, doorSide: 'LEFT SIDE', haltMins: 10, pillarInfo: 'Pillar #6 & Ramp' },
    { code: 'CNB', name: 'Kanpur Central', platform: 'Platform 1', scheduledArr: '03:20', scheduledDep: '03:25', distanceKm: 1011, doorSide: 'LEFT SIDE', haltMins: 5, pillarInfo: 'Pillar #8 & Main Exit' },
    { code: 'NDLS', name: 'New Delhi', platform: 'Platform 14', scheduledArr: '10:25', scheduledDep: '--:--', distanceKm: 1458, doorSide: 'RIGHT SIDE', haltMins: 0, pillarInfo: 'Pillar #4 & North Overbridge' },
  ],
  '12329': [
    { code: 'SDAH', name: 'Sealdah Terminus', platform: 'Platform 12', scheduledArr: '--:--', scheduledDep: '13:10', distanceKm: 0, doorSide: 'RIGHT SIDE', haltMins: 0, pillarInfo: 'Pillar #2 & South Portico' },
    { code: 'DHN', name: 'Dhanbad Junction', platform: 'Platform 3', scheduledArr: '16:50', scheduledDep: '16:55', distanceKm: 266, doorSide: 'LEFT SIDE', haltMins: 5, pillarInfo: 'Pillar #8 & FOB' },
    { code: 'GAYA', name: 'Gaya Junction', platform: 'Platform 1', scheduledArr: '20:00', scheduledDep: '20:05', distanceKm: 461, doorSide: 'RIGHT SIDE', haltMins: 5, pillarInfo: 'Pillar #11 & FOB' },
    { code: 'DDU', name: 'Pt. Deen Dayal Upadhyaya', platform: 'Platform 2', scheduledArr: '22:30', scheduledDep: '22:40', distanceKm: 666, doorSide: 'LEFT SIDE', haltMins: 10, pillarInfo: 'Pillar #6 & Ramp' },
    { code: 'CNB', name: 'Kanpur Central', platform: 'Platform 1', scheduledArr: '03:10', scheduledDep: '03:15', distanceKm: 1011, doorSide: 'LEFT SIDE', haltMins: 5, pillarInfo: 'Pillar #8 & Main Exit' },
    { code: 'ANVT', name: 'Anand Vihar Terminus', platform: 'Platform 3', scheduledArr: '11:50', scheduledDep: '--:--', distanceKm: 1448, doorSide: 'RIGHT SIDE', haltMins: 0, pillarInfo: 'Platform Pillar #6 & East Exit' },
  ],
};
...
const CORRIDORS: string[][] = [
  ...
  ['NDLS', 'ANVT', 'DLI', 'DEE', 'GZB', 'ALJN', 'TDL', 'ETW', 'CNB', 'PRYJ', 'DDU', 'BXR', 'ARA', 'DNR', 'PPTA', 'PNBE', 'RJPB', 'BJU', 'KGG', 'NNA', 'KIR', 'BOE', 'KNE', 'AUB', 'NJP', 'GHY'],
  ...
  ['HWH', 'SDAH', 'KOAA', 'SHM', 'BWN', 'RPH', 'MLDT', 'BOE', 'KNE', 'NJP'],
  ['MAS', 'MS', 'TBM', 'AJJ', 'KPD', 'JTJ', 'BWT', 'KJM', 'SMVB', 'YPR', 'SBC', 'SA', 'ED', 'TUP', 'CBE', 'PGT', 'TCR', 'AWY', 'ERS', 'TVC'],
  ['CSMT', 'BDTS', 'MMCT', 'LTT', 'TNA', 'PNVL', 'ROHA', 'RN', 'KUDL', 'MAO', 'KAWR', 'UD', 'MAJN', 'CAN', 'CLT', 'SRR', 'ERS'],
];
...
export const KNOWN_TRAIN_NAMES: Record<string, string> = {
  ...
  '12246': 'Yesvantpur - Howrah Duronto',
  ...
  '12584': 'Anand Vihar - Lucknow Double Decker',
  '12213': 'Yesvantpur - Delhi Sarai Rohilla Duronto',
  '12214': 'Delhi Sarai Rohilla - Yesvantpur Duronto',
  '12269': 'Chennai - Hazrat Nizamuddin Duronto',
  '12270': 'Hazrat Nizamuddin - Chennai Duronto',
  '12285': 'Secunderabad - Hazrat Nizamuddin Duronto',
  '12286': 'Hazrat Nizamuddin - Secunderabad Duronto',
  '12925': 'Paschim Express',
  '12926': 'Paschim Express',
  '12219': 'LTT - Secunderabad Duronto Express',
  '12220': 'Secunderabad - LTT Duronto Express',
  ...
  '12837': 'Howrah - Puri SF Express',
  '12628': 'Karnataka Express (Delhi - Bengaluru)',
  '12127': 'Mumbai - Pune Intercity SF Express',
  '12420': 'New Delhi - Lucknow Gomti Express',
  '22302': 'Vande Bharat Express (NJP)',
  '12424': 'Dibrugarh Rajdhani Express (via NJP)',
