...
import { advanceCitizenJourney, sendCitizenQuery } from '@app/services/api';
import { TrainOption } from '@app/types';
      ...
      {phase === 'landing' && (
        <div className="max-w-2xl mx-auto rounded-3xl border border-white/10 bg-[#060b14]/80 p-8 space-y-6">
          ...
          <button
            ...
            className="w-full py-3 rounded-2xl bg-gradient-to-r from-[#00FF9D] to-teal-400 text-slate-950 font-black disabled:opacity-30"
          >
            Continue
          </button>
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              {POPULAR.map((task) => (
                <button
                  ...
                  className="text-left px-4 py-3 rounded-xl border border-white/10 text-sm text-slate-200 hover:border-[#00FF9D]/40"
                >
                  • {task.label}
                </button>
              ))}
        ...
        <div className="max-w-xl mx-auto rounded-3xl border border-white/10 bg-[#060b14]/80 p-8 space-y-4">
          ...
          <div className="flex gap-3 pt-2">
            <button
              ...
              className="flex-1 py-3 rounded-2xl bg-[#00FF9D] text-slate-950 font-black"
            >
              Correct
            </button>
            <button
              ...
              className="flex-1 py-3 rounded-2xl border border-white/20 text-white font-bold"
            >
              Edit
            </button>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          <div className="lg:col-span-8 rounded-3xl border border-white/10 bg-[#060b14]/80 flex flex-col min-h-[540px] overflow-hidden">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {topOptions.map((opt) => (
                    <button
                      ...
                      className="text-left p-4 rounded-2xl border border-white/10 hover:border-[#00FF9D]/40 space-y-2"
                    >
              ...
              {stage === 'PASSENGER' && (
                <div className="space-y-3 p-4 rounded-2xl border border-white/10">
                  ...
                  <button
                    ...
                    className="px-4 py-2 rounded-xl bg-[#00FF9D] text-slate-950 font-bold"
                  >
                    Continue
                  </button>
                </div>
              ...
              {stage === 'REVIEW' && (
                <div className="space-y-3 p-4 rounded-2xl border border-[#00FF9D]/30">
                  ...
                  <button
                    ...
                    className="px-4 py-2 rounded-xl bg-[#00FF9D] text-slate-950 font-black"
                  >
                    Mock payment
                  </button>
                </div>
            ...
            <div className="p-4 border-t border-white/10 flex gap-2">
              <button onClick={() => setIsRecording(!isRecording)} className={`p-3 rounded-2xl border ${isRecording ? 'bg-rose-500' : 'border-white/10'}`}>
              ...
              />
              <button onClick={() => startFromQuery(inputQuery)} className="p-3 rounded-2xl bg-[#00FF9D] text-slate-950">
