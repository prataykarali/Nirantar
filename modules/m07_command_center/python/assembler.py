"""Assemble the operator snapshot from PortalPulse + Kavach + Dhara + PRAYOG."""
...
class CommandCenterService:
    ...
    def _live(self, event: TelemetryEvent) -> LiveSystemState:
        ...
        return LiveSystemState(
            ...
            requests_per_sec=round(event.requests_per_sec, 0),
            cpu_percent=round(event.cpu_percent, 1),
            latency_ms=round(event.latency_p99_ms, 0),
